...
private:
  ...
  void dump_vector(const char *filename, std::vector<double> &vector,
		   bool append=true );
private:
  ...
  std::vector <double> E_electron_vector;
  std::vector <double> E_positron_vector;
  std::vector <double> E_photon_vector;
  std::vector <double> E_neutron_vector;
  std::vector <double> E_proton_vector;
  std::vector <double> E_alpha_vector;
  std::vector <double> E_other_vector;
  std::vector <double> E_total_vector;    
